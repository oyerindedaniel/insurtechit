...
export const CoreValues = [
  {
    ...
    className:
      'sm:col-start-1 sm:col-end-7 sm:row-start-1 sm:row-end-5 lg:col-start-1 lg:col-end-5 lg:row-start-1 lg:row-end-7'
  },
  {
    image:
    ...
    className:
      'sm:col-start-7 sm:col-end-13 sm:row-start-1 sm:row-end-5 lg:col-start-5 lg:col-end-9 lg:row-start-1 lg:row-end-7'
  },
  {
    image:
    ...
    className:
      'sm:col-start-1 sm:col-end-7 sm:row-start-5 sm:row-end-9 lg:col-start-9 lg:col-end-13 lg:row-start-1 lg:row-end-7'
  },
  {
    image:
    ...
    className:
      'sm:col-start-7 sm:col-end-13 sm:row-start-5 sm:row-end-9 lg:col-start-1 lg:col-end-5 lg:row-start-7 lg:row-end-13'
  }
] as const;
